                    ...
                    {message.files.map((file) =>
                      isMobile ? (
                        <button
                          ...
                          className="flex items-center gap-1 bg-gray-100 hover:bg-gray-200 rounded-lg px-3 py-2 text-sm transition-colors cursor-pointer"
                        >
                        ...
                        <Popover key={file.id}>
                          <PopoverTrigger asChild>
                            <button className="flex items-center gap-1 bg-gray-100 hover:bg-gray-200 rounded-lg px-3 py-2 text-sm transition-colors cursor-pointer">
                              <Paperclip className="h-4 w-4" />
                              <span className="truncate max-w-[150px]">{file.filename}</span>
                              <span className="text-xs text-gray-500">
                                {(file.size / 1024).toFixed(0)} KB
